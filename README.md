...
```
HR-analysis/
├── test-task.ipynb          # Основной ноутбук с анализом
...
Для работы ноутбука необходимы данные в формате Excel с информацией о:
...
*Проект создан для анализа эффективности рекрутинговых процессов и оптимизации найма персонала.*
